  ...
  return (
    <section className="py-24">
      ...
      <div className="w-full mt-18 flex flex-col justify-center items-center md:flex-row gap-6 px-4 md:px-12">
        ...
        <Card title="Development & Progress Update" description="Once we agree on the plan, I cue my lofi playlist and dive into coding. From initial sketches to polished code, I keep you updated every step of the way." icon={<AceternityIcon order='Second Task' />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Development & Launch" description="This is where the magic happens! Based on the approved design, I'll translate everything into functional code, building your website from the ground up." icon={<AceternityIcon order='Third Task' />}>
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    <div>
      <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-6 py-3 text-sm md:text-xl font-semibold text-white backdrop-blur-3xl">
          {order}
        </span>
      </button>
    </div>
