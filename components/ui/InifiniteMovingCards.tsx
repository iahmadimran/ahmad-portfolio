  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-slate-800 p-5 md:p-12 md:w-[60vw]"
            key={idx}
            style={{
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className="relative z-20 text-sm md:text-xl leading-[1.6] font-normal text-white dark:text-gray-100">
                {item.quote}
              </span>
